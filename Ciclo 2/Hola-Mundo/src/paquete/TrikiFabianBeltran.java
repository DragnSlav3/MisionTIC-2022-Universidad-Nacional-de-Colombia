// Descargado de https://github.com/FabianBeltran96

package paquete;

import java.util.Scanner;

public class TrikiFabianBeltran {
    ...
    public static void main(String[] args) {
        TrikiFabianBeltran partida = new TrikiFabianBeltran(); //Creo la partida
        int[] posiciones = {0, 0};
